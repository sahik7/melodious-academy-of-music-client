...
const ManageClasses = () => {
  ...
  const handleFeedbackSubmit = () => {
    ...
    updateClassStatus(classId, 'feedback', feedback);
  };
          ...
          {manageClasses.map((item, index) => (
            <tr key={index}>
              ...
              <td className="table-data space-y-3">
                ...
                <button
                  className="bg-main/20 border-2 rounded border-main font-bold text-sm py-1 px-6 mx-auto mr-2"
                ...
                <button
                  className="bg-second/20 border-2 rounded border-second font-bold text-sm py-1 px-3 mr-2"
