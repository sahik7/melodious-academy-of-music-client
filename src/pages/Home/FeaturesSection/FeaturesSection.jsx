...
const FeaturesSection = () => {
  ...
  return (
    ...
    <div className="grid lg:grid-cols-4 grid-cols-1 gap-8 my-64">
      <div className="border-2 border-second rounded-lg p-8 text-center lg:-mt-10 bg-main flex justify-center items-center"><div className="">
...
Achieve progress and make significant strides towards your goals by actively participating in our weekly tasks led by our experienced instructors. </p>
      ...
      <div className="border-2 border-main rounded-lg p-8 text-center lg:-mb-10 bg-second flex justify-center items-center"><div className="">
